...
// Lo siguiente hace el siguimiento de la imagen
(function() {
	var i = 0,
		lastTime = 0,
...
var App = {
	...
	denied: function() {
		App.info.innerHTML = 'Usted no inicio la Camara!<br>Por Favor intente de nuevo.';
	},
	error: function(e) {
		if (e) {
			console.error(e);
		}
		App.info.innerHTML = 'Por Favor utilice  Google Chrome y habilite la opcion MediaStream flag del navegador';
	},
